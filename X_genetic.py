...
def genetic(
    ...
    generation, time_taken, new_matrix = GA_results(initial_matrix)    
    time_taken = round(time_taken,4)
    
    color_white = (255,255,255) 
    mediumfont = pygame.font.SysFont('Corbel',20)
    gridfont = pygame.font.SysFont("comicsans", 42) 
    algo_name = largefont.render('Genetic algorithm' , True , color_white)
    ...
    text_below1 = mediumfont.render('Solved at generation: '+str(generation) , True , color_dark)
    ...
    while True: 
        ...
        screen.blit(algo_name, (235, 732))
        screen.blit(text_quit, (548, 732))
        screen.blit(text_below1, (239, 664))
