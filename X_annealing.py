...
def annealing(
    ...
    new_matrix, count, time_taken = Stage(np.array(initial_matrix))    
    time_taken = round(time_taken,4)
    
    color_white = (255,255,255) 
    mediumfont = pygame.font.SysFont('Corbel',20)
    gridfont = pygame.font.SysFont("comicsans", 42) 
    algo_name = largefont.render('Simulated annealing' , True , color_white)
    ...
    text_below1 = mediumfont.render('Energy: '+str(count) , True , color_dark)
    ...
    while True: 
        ...
        screen.blit(algo_name, (222, 732))
        screen.blit(text_quit, (548, 732))
        screen.blit(text_below1, (283, 664))
